function NewsComponent() {
  return (
    <div className="grid sm:lggrid-2 lg:grid-cols-4 gap-[30px] mt-[40px]">
      <div className="shadow rounded-[8px] h-[330px]">
        ...
        <div className="px-[15px] mt-[20px]">
          ...
          <button className="text-primary font-poppins mt-[10px] border p-[5px_12px] rounded-[5px] text-[14px]">Read More</button>
        </div>
      </div>
